...
const QMetaObject openGL::staticMetaObject = {
    { &QGLWdiget::staticMetaObject, qt_meta_stringdata_openGL.data,
      qt_meta_data_openGL,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *openGL::qt_metacast(const char *_clname)
{
    ...
    return QGLWdiget::qt_metacast(_clname);
}

int openGL::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QGLWdiget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
